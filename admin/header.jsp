...
<html lang="en">
<head>
<title>DerpGang - File Hosting</title>
<!-- custom-theme -->
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item"><a href="index.jsp" class="menu__link">Home</a></li>
                            <li class="menu__item"><a href="registered.jsp" class="menu__link">Registerd Users</a></li>
                            <li class="menu__item"><a href="files.jsp" class="menu__link">User Files</a></li>
                            <li class="menu__item"><a href="feed.jsp" class="menu__link">Feedbacks</a></li>
							<li class="menu__item"><a href="logout.jsp" class="menu__link">Logout</a></li>
						</ul>
					</nav>
				</div>
			</nav>
